...
-  **Detection of 19 runtime security vulnerabilities** (WARN-NEW: 19)  
-  Automated DAST pipeline with GitHub Actions
-  Comprehensive security report generation with 128 passed checks
...
**![ZAP Baseline Scan Results](img-4/baseline.png)**
*ZAP Baseline scan results showing detected runtime vulnerabilities*

**![ZAP Full Scan Report](img-4/4b-1.png)**
...
- **Low Risk**: 8+ vulnerabilities (Information disclosure)
...
**![ZAP Workflow Configuration](img-4/4b-3.png)**
...
- **Runtime Security Validation**: **19 vulnerabilities detected** in running application (WARN-NEW: 19)
...
- **Security Validation**: 128 security checks passed successfully
...
- **Vulnerability Detection**: **19 runtime security issues identified** (WARN-NEW: 19)
- **Security Validation**: 128 security checks passed successfully
...
- Error: "Resource not accessible by integration" when ZAP tries to create GitHub issues
- **Impact**: None - scan results are unaffected, all 19 vulnerabilities detected successfully
- **Cause**: GitHub Actions token lacks issue creation permissions
- **Solution**: Reports are available as workflow artifacts (HTML/JSON formats)
